  ...
  <head>
      ...
      <style>
          ...
          * { box-sizing: border-box; outline: none; -webkit-tap-highlight-color: transparent; }
          ...
          .card h4 { font-size: 0.85rem; font-weight: 600; margin: 0 0 4px 0; color: var(--text); overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; line-height: 1.3; height: 2.6em; }
          .stock { font-size: 0.7rem; color: var(--text-muted); margin-bottom: 6px; }
          .price { color: var(--primary); font-weight: 700; font-size: 0.95rem; }
          ...
          .modal-content { background: white; border-radius: 16px; width: 90%; max-width: 400px; padding: 20px; position: relative; box-shadow: 0 20px 50px rgba(0,0,0,0.1); transform: scale(0.95); transition: 0.3s; max-height: 85vh; overflow-y: auto; color: var(--text); }
          .modal.active .modal-content { transform: scale(1); }
          .close-icon { position: absolute; top: 15px; right: 15px; color: var(--text-muted); cursor: pointer; background: #f0f0f0; width: 28px; height: 28px; display:flex; align-items:center; justify-content:center; border-radius:50%; }
          ...
          .toast { background: white; color: var(--text); padding: 12px 16px; border-radius: 30px; margin-bottom: 10px; font-size: 0.9rem; font-weight: 600; display: flex; align-items: center; gap: 10px; box-shadow: 0 5px 20px rgba(0,0,0,0.1); }
          ...
          <div class="admin-container">
              ...
              <div class="admin-content">
                  ...
                  <div id="adminTabConf" style="display:none;">
                      ...
                      <div class="admin-card">
                          <div class="admin-card-title">Tampilan Link Share</div>
